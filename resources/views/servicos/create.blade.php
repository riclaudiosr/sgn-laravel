...
@section('title', 'Novo Serviço - SGN')
...
<div class="container">
    ...
    <div class="mb-4">
        ...
        <p class="text-muted mb-0">
            Cadastre um serviço realizado para um cliente.
        </p>
            ...
            <form
                ...
                <div class="mb-4">
                    ...
                    <select
                        ...
                        <option
                            value="Pendente"
                            {{ old('situacao') == 'Pendente' ? 'selected' : '' }}>
                            Pendente
                        </option>

                        <option
                            value="Concluído"
                            {{ old('situacao') == 'Concluído' ? 'selected' : '' }}>
                            Concluído
                        </option>

                        <option
                            value="Cancelado"
                            {{ old('situacao') == 'Cancelado' ? 'selected' : '' }}>
                            Cancelado
                        </option>
